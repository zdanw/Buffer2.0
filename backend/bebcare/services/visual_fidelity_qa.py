    ...
    *,
    ...
    material = {
        ...
        "logo": {
            ...
            "wordmark_digest": canonical_digest(logo.get("wordmark_authority") or ""),
        },
        "usage_policy_digest": canonical_digest(plan.get("usage_policy") or {}),
        "provider_image_order": plan.get("provider_image_order") or [],
