...
export const zh: TranslationTree = {
  ...
  landing: {
    ...
    navFeatures: '功能',
    navForTeams: '适用对象',
    heroTitle1: '忙碌时，别再让曝光掉下去',
    heroTitle2: '忙碌的一周，不该换来曝光下滑',
    heroTitle3: '你经营业务时，社媒照常运转',
    heroTitle4: '社媒赢在稳定。忙碌的团队输在断更。',
    heroTitle5: '社媒渠道，全自动化运营',
    heroSubtitle: '一次配置品牌。PulseForge 每天替你发帖——全平台自动发布。',
    heroTrustLine: '免费开始 · 5 分钟上线',
    ...
    footerDescription:
      'PulseForge 是面向成长型品牌的社媒自动化平台。一次配置品牌规则——AI 每天生成品牌一致的内容并发布到 Instagram、TikTok、Facebook，忙碌时也不掉曝光。',
    footerPlatforms: '支持 Instagram、TikTok、Facebook 自动发布。',
    footerProductHeading: '产品',
    footerAccountHeading: '账户',
    footerProductNav: '产品链接',
    footerAccountNav: '账户链接',
    footerCopyright: '© {{year}} PulseForge. 保留所有权利。',
  },
  imageProviders: {
    title: '图像模型',
