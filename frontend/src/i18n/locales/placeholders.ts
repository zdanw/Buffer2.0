...
export const placeholdersEn: TranslationTree = {
  placeholders: {
    brands: {
      ...
      logoFontRule: 'e.g. Solid black wordmark; never stretch, recolor, or redraw',
...
export const placeholdersZh: TranslationTree = {
  placeholders: {
    brands: {
      ...
      logoFontRule: '例如：纯黑字标；禁止拉伸、改色或重绘',
