...
export const pagesEn: TranslationTree = {
  ...
  subscribeCredits: {
    ...
    activeSub: 'Subscription active. Next renewal: {{date}}.',
    pendingCancel: 'Cancellation scheduled. Access continues until {{date}}; no further charges after that.',
    cancelCta: 'Cancel subscription',
    resumeCta: 'Resume auto-renewal',
    cancelConfirm:
      'Cancel at period end? You keep current-period credits until they expire. No automatic refund. You can resume before the period ends.',
...
export const pagesZh: TranslationTree = {
  ...
  subscribeCredits: {
    ...
    resumeCta: '恢复自动续费',
    cancelConfirm:
      '确认取消订阅？当期费用不退，可继续用至过期。周期结束前可恢复续费。',
    cancelFailed: '取消订阅失败。',
    resumeFailed: '恢复续费失败。',
  },
  referenceImages: {
