...
export const pagesEn: TranslationTree = {
  ...
  dimensionsPage: {
    title: 'Visual styles',
    subtitle: 'Photo style options used when generating images (shared across all brands)',
    emptyStateHint: 'Default styles are loaded automatically. Add or edit rows here to customize.',
  ...
  imageModelPicker: {
    ...
    tooltips: {
      ...
      provider: 'Image API provider. System default uses the server-configured provider.',
...
export const pagesZh: TranslationTree = {
  ...
  dimensionsPage: {
    title: '视觉风格',
    subtitle: '生成图像时使用的照片风格选项（全站所有品牌共享）',
    emptyStateHint: '默认风格会在启动时自动加载。可在此添加或编辑条目进行自定义。',
    addDimension: '添加维度',
    editDimension: '编辑维度',
    importPresets: '导入预设…',
    importGeneral: '通用（中性）',
  ...
  imageModelPicker: {
    ...
    tooltips: {
      ...
      provider: '图像 API 提供商。系统默认使用服务器配置的提供商。',
