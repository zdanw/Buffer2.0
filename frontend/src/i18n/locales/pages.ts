...
export const pagesEn: TranslationTree = {
  ...
  imageModelPicker: {
    ...
    loading: '(loading…)',
    systemDefault: 'Your default provider',
    ...
    emptyUsesDefault: 'Leave empty to use your default provider',
    ...
    tooltips: {
      ...
      provider: 'Image API providers you have added. Only your own providers appear here.',
