...
export const pagesEn: TranslationTree = {
  assets: {
    ...
    preferredHint: 'Used first as the primary reference of this type',
    uploading: 'Uploading…',
    ...
    updatingList: 'Updating product list…',
    loadProductsFailed: 'Could not load products. Please try again.',
    ...
    visualSetup: 'Visual setup (optional)',
    visualSetupHint: 'Select a type to improve image accuracy.',
    visualSetupAutoDetect: 'Auto-detect',
    visualSetupChange: 'Change',
    visualSetupChoose: 'Choose',
    visualSetupSuggested: 'Suggested',
    visualSetupChoices: {
  ...
  brands: {
    ...
    selector: {
      ...
      loadingProductsFor: 'Loading products for {{brand}}…',
      loadingAllProducts: 'Loading products across all brands…',
  ...
  studio: {
    ...
    compareUsesTwoCredits: 'Comparison uses 2 platform image credits (one per pipeline).',
  ...
  tasks: {
    ...
    updatingList: 'Updating task list…',
    addTask: 'Add task',
    editTask: 'Edit task',
    taskName: 'Task name',
    taskMode: 'Task mode',
    ...
    referenceImages: '{{count}} reference image(s)',
    runsPerRound: '{{count}} round(s) · all selected products',
    imagesPerRun: '{{count}} image(s) per run',
    copiesPerRun: '{{count}} copy variant(s)',
  ...
  pending: {
    ...
    updatingList: 'Updating draft list…',
  ...
  preview: {
    ...
    qualityNotice: 'Image could not be validated',
    limitedReference: 'Some product details may be hard to match from the available photos',
    referenceDetails: 'Reference details',
    referenceCoverage: 'Coverage',
    diversityRotated: 'Safe rotation used',
    selectorReasonLimited: 'Limited photo coverage',
    selectorReasonStable: 'Stable primary photo',
    selectorReasonRotated: 'Safe reference rotation',
    fidelityProduct: 'Product details may differ from the reference',
    fidelityBranding: 'Branding could not be verified',
    fidelityPlacement: 'Unsupported product placement detected',
    fidelityRendered: 'Image appears heavily rendered',
    fidelityPublishPaused: 'Automatic publishing paused',
  ...
  calendar: {
    ...
    loadingBrand: 'Applying brand filter…',
    upcoming: 'Upcoming',
  ...
  generationHistory: {
    ...
    subtitle: 'Browse provenance-tracked image generations across all users.',
    loadFailed: 'Failed to load generation history',
    detailFailed: 'Failed to load generation run details',
    empty: 'No generation runs match your filters.',
    ...
    filterQaAll: 'All QA results',
    filterQaYes: 'Has QA failures',
    filterQaNo: 'No QA failures',
    ...
    selected: 'Selected',
    promptUnavailable: 'Prompt unavailable for this run.',
    qaFindings: 'Quality findings',
    creditsSection: 'Credits',
    creditsCharged: '{{n}} credits charged',
    reservationStatus: 'Reservation: {{status}}',
    grantSource: 'Grant source: {{source}}',
    pipelineSection: 'Pipeline',
    latency: '{{ms}} ms',
    compareSiblings: 'Compare group siblings',
    technicalJson: 'Technical JSON',
    stagePreGeneration: 'Blocked before generation',
    stagePostGeneration: 'Quality check on output',
    stagePublishGate: 'Blocked from auto-publish',
    runList: 'Runs',
    runId: 'Run ID',
    noThumb: 'No image',
    creditsShort: '{{n}} cr',
    ...
    activeUserFilter: 'Filtered by user',
    chipUsername: 'Username: {{value}}',
    chipEmail: 'Email: {{value}}',
    chipStatus: 'Status: {{value}}',
    chipSource: 'Source: {{value}}',
    chipDateRange: '{{from}} → {{to}}',
    noOutputImages: 'No output images were saved for this run.',
    noOutputFailedHint: 'The generation may have failed before an image was produced.',
    promptExpired: 'Prompt unavailable — the linked async task has expired (48h retention).',
    promptPreMigration: 'Prompt unavailable — this run predates output snapshot storage.',
    selectedArtifactHint: 'Highlighted image was selected for publish or compare.',
  },
...
export const pagesZh: TranslationTree = {
  assets: {
    ...
    preferred: '首选',
    setPreferred: '设为首选参考',
    preferredHint: '作为该类型的主参考图优先使用',
    uploading: '上传中…',
    saveChanges: '保存修改',
    startingUp: '服务正在启动中，请稍候...',
    loadingProducts: '正在加载产品…',
    searchProducts: '按名称、分类或品牌搜索…',
    noSearchResults: '没有匹配的产品',
    updatingList: '正在更新产品列表…',
    loadProductsFailed: '无法加载产品，请重试。',
    noProducts: '暂无产品',
    ...
    visualSetup: '视觉呈现方式（可选）',
    visualSetupHint: '选择类型可提高图片准确度。',
    visualSetupAutoDetect: '自动识别',
    visualSetupChange: '更改',
    visualSetupChoose: '选择',
    visualSetupSuggested: '建议',
    visualSetupChoices: {
      physical_product: '实体产品',
      software: '软件或应用',
      service: '服务',
      digital_product: '数字内容',
  ...
  brands: {
    ...
    selector: {
      ...
      viewingAll: '查看全部品牌',
      loading: '正在加载品牌数据',
      loadingProductsFor: '正在加载 {{brand}} 的产品…',
      loadingAllProducts: '正在加载全部品牌的产品…',
  ...
  studio: {
    ...
    compareUsesTwoCredits: '对比会消耗 2 次平台出图额度（每条链路各 1 次）。',
  ...
  tasks: {
    ...
    categories: '分类: {{list}}',
    platforms: '平台: {{list}}',
    referenceImages: '{{count}} 张参考图',
    runsPerRound: '每轮 {{count}} 次 · 覆盖全部已选产品',
    imagesPerRun: '每次 {{count}} 张图片',
    copiesPerRun: '每次 {{count}} 条文案',
  ...
  preview: {
    ...
    generateError: '生成失败',
    qualityNotice: '图片未能通过校验',
    limitedReference: '现有照片可能难以完整还原产品细节',
    referenceDetails: '参考图说明',
    referenceCoverage: '覆盖程度',
    diversityRotated: '已使用安全轮换',
    selectorReasonLimited: '照片覆盖有限',
    selectorReasonStable: '使用稳定主参考图',
    selectorReasonRotated: '安全参考图轮换',
    fidelityProduct: '产品细节可能与参考图不一致',
    fidelityBranding: '品牌标识无法核验',
    fidelityPlacement: '检测到不支持的产品摆放',
    fidelityRendered: '画面看起来偏三维渲染',
    fidelityPublishPaused: '已暂停自动发布',
    processing: '处理中...',
  ...
  generationHistory: {
    title: '生成历史',
    subtitle: '查看所有用户的图像生成记录与溯源信息。',
    loadFailed: '加载生成历史失败',
    detailFailed: '加载生成详情失败',
    empty: '没有符合筛选条件的生成记录。',
    selectRun: '请选择一条记录查看详情。',
    applyFilters: '应用筛选',
    clearUserFilter: '清除用户筛选',
    filterUsername: '按用户名筛选',
    filterEmail: '按邮箱筛选',
    ...
    outputImages: '输出图片',
    selected: '已选中',
    promptUnavailable: '该记录没有保存提示词。',
    qaFindings: '质检结果',
    creditsSection: '额度',
    creditsCharged: '已扣 {{n}} 次',
    reservationStatus: '预扣状态：{{status}}',
    grantSource: '额度来源：{{source}}',
    pipelineSection: '流水线',
    latency: '{{ms}} 毫秒',
    compareSiblings: '对比组其他结果',
    technicalJson: '技术 JSON',
    stagePreGeneration: '生成前拦截',
    stagePostGeneration: '输出质检',
    stagePublishGate: '自动发布拦截',
    runList: '生成记录',
    runId: '运行 ID',
    noThumb: '无图',
    creditsShort: '{{n}} 次',
    ...
    activeUserFilter: '按用户筛选',
    chipUsername: '用户名：{{value}}',
    chipEmail: '邮箱：{{value}}',
    chipStatus: '状态：{{value}}',
    chipSource: '来源：{{value}}',
    chipDateRange: '{{from}} → {{to}}',
    noOutputImages: '该记录未保存输出图片。',
    noOutputFailedHint: '生成可能在出图前已失败。',
    promptExpired: '提示词不可用 — 关联的异步任务已过期（保留 48 小时）。',
    promptPreMigration: '提示词不可用 — 该记录早于输出快照功能。',
    selectedArtifactHint: '高亮图片为发布或对比所选结果。',
  },
  systemImageProviders: {
    title: '平台图像供应商',
